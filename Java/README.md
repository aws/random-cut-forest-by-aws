...
```text
$ java -cp core/target/randomcutforest-core-[rcf-version].jar com.amazon.randomcutforest.runner.AnomalyScoreRunner < ../example-data/rcf-paper.csv > example_output.csv
...
```text
$ java -cp core/target/randomcutforest-core-[rcf-version].jar com.amazon.randomcutforest.runner.AnomalyScoreRunner --help
Usage: java -cp target/random-cut-forest-[rcf-version].jar com.amazon.randomcutforest.runner.AnomalyScoreRunner [options] < input_file > output_file
...
```text
% java -jar benchmark/target/randomcutforest-benchmark-[rcf-version]-jar-with-dependencies.jar
```
...
```text
% java -jar benchmark/target/randomcutforest-benchmark-[rcf-version]-jar-with-dependencies.jar RandomCutForestBenchmark\.updateAndGetAnomalyScore
