...
```text
$ java -cp core/target/randomcutforest-core-3.0.0-SNAPSHOT.jar com.amazon.randomcutforest.runner.AnomalyScoreRunner < ../example-data/rcf-paper.csv > example_output.csv
...
```text
$ java -cp core/target/randomcutforest-core-3.0.0-SNAPSHOT.jar com.amazon.randomcutforest.runner.AnomalyScoreRunner --help
Usage: java -cp target/random-cut-forest-3.0.0-SNAPSHOT.jar com.amazon.randomcutforest.runner.AnomalyScoreRunner [options] < input_file > output_file
...
```text
% java -jar benchmark/target/randomcutforest-benchmark-3.0.0-SNAPSHOT-jar-with-dependencies.jar
```
...
```text
% java -jar benchmark/target/randomcutforest-benchmark-3.0.0-SNAPSHOT-jar-with-dependencies.jar RandomCutForestBenchmark\.updateAndGetAnomalyScore
```
