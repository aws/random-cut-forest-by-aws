...
public abstract class AbstractForestTraversalExecutor {
     ...
     * to a tree. The results from all the trees are combined using the accumulator and then
     ...
     *     forest.
     */
    public abstract <R, S> S traverseForest(
            double[] point,
     ...
     * submitted to a tree. The results from all the trees are combined using the accumulator and
     * then transformed using the finisher before being returned.
     *
     * @param point The point that defines the traversal path.
     ...
     *     forest.
     */
    public abstract <R, S> S traverseForestMulti(
            double[] point,
     ...
     * Visit each of the trees in the forest and combine the individual results into an aggregate
     * result. A multi-visitor is constructed for each tree using the visitor factory, and then
     * submitted to a tree. The results from individual trees are collected using the {@link
     * java.util.stream.Collector} and returned. Trees are visited in parallel using {@link
