...
public class CompactRandomCutTreeFloatMapper implements
    ...
    public CompactRandomCutTreeFloat toModel(CompactRandomCutTreeState state, CompactRandomCutTreeContext context,
        ...
        return new CompactRandomCutTreeFloat.Builder().maxSize(context.getMaxSize()).randomSeed(seed)
                .pointStore((PointStoreFloat) context.getPointStore()).nodeStore(nodeStore).root(state.getRoot())
