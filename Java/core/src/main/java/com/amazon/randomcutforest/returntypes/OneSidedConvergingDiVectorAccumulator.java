 ...
 * sum of entries (i.e., the "high-low sum") in the submitted DiVectors for convergence and returns
 * the sum of all submitted DiVectors.
 */
public class OneSidedConvergingDiVectorAccumulator extends OneSidedStDevAccumulator<DiVector> {
     ...
     *     accumulator.
     */
    public OneSidedConvergingDiVectorAccumulator(
            int dimensions,
