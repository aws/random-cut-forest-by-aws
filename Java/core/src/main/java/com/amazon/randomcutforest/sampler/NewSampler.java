 ...
 */
public class NewSampler<P> implements IStreamSamplerNew<P> {
    ...
    public NewSampler(final int sampleSize, final double lambda, Random random, boolean storeSequenceIndices) {
    ...
    public NewSampler(int sampleSize, final double lambda, long seed, boolean storeSequenceIndices) {
        this(sampleSize, lambda, new Random(seed), storeSequenceIndices);
    }

    public NewSampler(int sampleSize, final double lambda, long seed) {
