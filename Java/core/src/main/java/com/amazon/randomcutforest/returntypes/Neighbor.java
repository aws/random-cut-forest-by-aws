...
/**
 * A Neighbor represents a point together with a distance, where the distance is with respect to
 * some query point. That is, we think of this point as being a neighbor of the query point. If the
 * feature is enabled in the forest, a Neighbor will also contain a set of sequence indexes
 * containing the times this point was added to the forest.
 */
public class Neighbor {
    ...
    /**
     * A list of sequence indexes corresponding to the times when this neighbor point was added to
     * the forest. If sequence indexes are not enabled for the forest, then this list will be empty.
     */
     ...
     * @param distance The distance between the neighbor point and the query point is was created
     *     from.
     * @param sequenceIndexes A list of sequence indexes corresponding to the times when this
    ...
    /**
     * Get Neighbor collector which merges duplicate Neighbors and sorts them in ascending order of
     * distance
     *
     * @return Neighbor collector
     */
    public static Collector<Optional<Neighbor>, Map<Integer, Neighbor>, List<Neighbor>>
            collector() {
    ...
    private static class CollectorImpl
        ...
        private void mergeNeighborIfNeededAndPut(
                Map<Integer, Neighbor> neighborsMap, Neighbor currentNeighbor) {
