...
public class CompactRandomCutTreeDoubleMapperTest {
    ...
    private static class TreeProvider implements ArgumentsProvider {
        ...
        public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
            ...
            trees.add(new CompactRandomCutTreeDouble(capacity, 99L, pointStore, false, false, false));
            trees.add(new CompactRandomCutTreeDouble(capacity, 99L, pointStore, false, false, true));
            trees.add(new CompactRandomCutTreeDouble(capacity, 99L, pointStore, false, true, false));
            trees.add(new CompactRandomCutTreeDouble(capacity, 99L, pointStore, false, true, true));
