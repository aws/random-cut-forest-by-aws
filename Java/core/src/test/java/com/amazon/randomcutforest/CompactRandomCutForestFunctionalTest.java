...
public class CompactRandomCutForestFunctionalTest {
    ...
    public static void
        ...
        singleThreadedForest =
                RandomCutForest.builder()
                        ...
                        .compact(true)
                        .storeSequenceIndexesEnabled(false)
                        .boundingBoxCacheFraction(new Random().nextDouble())
                        .parallelExecutionEnabled(false)
                        .build();

        parallelExecutionForestFloat =
                RandomCutForest.builder()
                        .numberOfTrees(numberOfTrees)
                        .sampleSize(sampleSize)
                        .dimensions(dimensions)
    ...
    public void treeSizeChangeTest(
            int numDims,
            int numTrees,
            int numSamples,
            int numTrainSamples,
