...
/**
 * This visitor computes a scalar anomaly score for a specified point. The basic score computation is defined by
 * {@link AbstractScalarScoreVisitor}, and this class overrides the scoring functions so that input points that are
 * more likely to separated from in-sample points by a random cut receive a higher anomaly score.
 *
