...
public class RandomCutTree {
	 ...
	 *
	 * @param randomSeed
	 *            The random seed used to create the random number generator for
	 *            this tree.
	 ...
	 * @param box
	 *            A bounding box that we want to find a random cut for.
	 ...
	 * @param newNode
	 *            The new node we are inserting into the tree.
	 */
	 ...
	 *
	 * @param node
	 *            The node whose sibling we are requesting.
	 ...
	 *
	 * @param weightedPoint
	 *            A point in the tree that we wish to delete.
	 */
	 ...
	 *
	 * @param node
	 *            node that we are visiting in the tree.
	 * @param point
	 *            the point that is being deleted from the tree.
	 * @param sequenceIndex
	 *            the insertion index of the point being deleted from the tree.
	 */
	 ...
	 *
	 * @param node
	 *            the current node in the tree we are on
	 * @param point
	 *            the point that we want to add to the tree
	 * @param sequenceIndex
	 *            the insertion index of the point being added to the tree
	 */
	 ...
	 *
	 * @param point
	 *            A point which determines the traversal path from the root to a
	 *            leaf node.
	 * @param visitor
	 *            A visitor that will be invoked for each node on the path.
	 * @param <R>
