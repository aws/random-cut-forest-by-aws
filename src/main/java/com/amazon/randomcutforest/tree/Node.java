...
public class Node {
	 ...
	 * @param cut
	 *            A Cut that divides the bounding box into two sections.
	 * @param boundingBox
	 *            The bounding box for this node.
	 * @param enableCenterOfMass
	 *            A flag indicating whether center of mass computations will be
	 ...
	 *
	 * @param leafPoint
	 *            The point that defines the new leaf node.
	 */
	 ...
	 * 
	 * @param point
	 *            A point that we are testing in comparison to the given node
	 * @param node
	 *            A non-leaf node
	 ...
	 *
	 * @param point
	 *            A point that we are comparing to this node's leaf point.
	 ...
	 * 
	 * @param point
	 *            A point value to subtract from this node's point sum.
	 */
	 ...
	 * 
	 * @param point
	 *            A point value to add to this node's point sum.
	 */
	 ...
	 * 
	 * @param sequenceIndex
	 *            A new sequence index to be added to this node..
	 */
