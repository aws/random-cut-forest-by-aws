...
public class BoundingBox {
	 ...
	 *
	 * @param point
	 *            the point for which we need a bounding box
	 */
	 ...
	 *
	 * @param minValues
	 *            The minimum values for each coordinate.
	 * @param maxValues
	 *            The maximum values for each coordinate
	 */
	private BoundingBox(final double[] minValues, final double[] maxValues) {
	 ...
	 *            the bounding box being merged with this box
	 ...
	 *
	 * @param point
	 *            the new point being added to the box
	 ...
	 *
	 * @param dimension
	 *            the dimension for which we need the max value
	 ...
	 *
	 * @param dimension
	 *            the dimension for which we need the min value
	 ...
	 *
	 * @param point
	 *            with which we're performing the comparison
	 ...
	 *
	 * @param other
	 *            Another bounding box that we are comparing to this bounding box.
