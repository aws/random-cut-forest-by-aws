...
public abstract class AbstractForestTraversalExecutor {
	 ...
	 *
	 * @param pointCopy
	 *            The point values that were are using the update the forest. The
	 *            name of this parameter is a reminder that we should update the
	 *            forest with a copy of the point that was passed in, since the
	 *            original point may be modified later.
	 * @param sequenceIndex
	 *            The sequence index to assign to this point. This should be a
	 *            unique value for every point submitted.
	 */
