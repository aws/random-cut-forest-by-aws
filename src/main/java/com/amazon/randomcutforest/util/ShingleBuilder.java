...
public class ShingleBuilder {
	 ...
	 * 
	 * @param dimensions
	 *            The number of dimensions in the input points.
	 * @param shingleSize
	 *            The number of points to store in a shingle.
	 * @param cyclic
	 *            If true, the shingle will use cyclic updates. If false, it will
	 *            use sliding updates.
	 */
	 ...
	 * 
	 * @param point
	 *            The new point to be added to the shingle.
	 */
	 ...
	 * 
	 * @param shingle
	 *            A buffer where the shingled point will be written.
	 */
