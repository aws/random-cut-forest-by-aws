...
public class InterpolationMeasure {
	 ...
	 * @param sampleSize
	 *            The samplesize of each tree in forest, which may be used for
	 *            normalization.
	 */
	 ...
	 *
	 * @param base
	 *            An InterpolationMeasure instance that we want to copy.
	 */
	 ...
	 *
	 * @param left
	 *            The InterpolationMeasure we are modifying. After calling this
	 *            method, fields in this InterpolationMeasure will contain a sum of
	 *            the previous values and the corresponding values from the right
	 *            InterpolationMeasure.
	 * @param right
	 *            An InterpolationMeasure that we want to add to the left vector.
	 ...
	 *
	 * @param dimensions
	 *            The number of spatial dimensions in the InterpolationMeasures
	 *            being collected.
	 * @param sampleSize
	 *            The sample size of the Random Cut Trees that were measured.
	 * @param numberOfTrees
	 *            The number of trees whose measures we are collecting into a final
