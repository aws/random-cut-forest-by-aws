...
public class DiVector {
	 ...
	 *
	 * @param dimensions
	 *            The number of dimensions of data to store.
	 */
	 ...
	 *
	 * @param left
	 *            The DiVector we are modifying. After calling this method, the low
	 *            and high values in the DiVector will contain a sum of the previous
	 *            values and the corresponding values from the right vector.
	 * @param right
	 *            A DiVector that we want to add to the left vector. This DiVector
	 ...
	 *
	 * @param function
	 *            A function to apply to every entry of the high and low arrays in
	 *            this DiVector.
	 */
