...
public class DynamicAttributionVisitor extends AbstractAttributionVisitor {
	 ...
	 *            threshold of mass for leaves to be ignored
	 * @param scoreSeen
	 *            part of the score when point has been seen
	 * @param scoreUnseen
	 *            part of the score for unseen point
	 * @param damp
	 *            dampening function for seen points
	 */
	 ...
	 *            mass of the tree
	 * @param ignoreLeafMassThreshold
	 *            mass of the leaves to be ignored
	 * @param scoreSeen
	 *            score when point has been seen
	 * @param scoreUnseen
	 *            score when point has not been seen
	 */
	public DynamicAttributionVisitor(double[] point, int treeMass, int ignoreLeafMassThreshold,
			BiFunction<Double, Double, Double> scoreSeen, BiFunction<Double, Double, Double> scoreUnseen) {
		super(point, treeMass, ignoreLeafMassThreshold);
