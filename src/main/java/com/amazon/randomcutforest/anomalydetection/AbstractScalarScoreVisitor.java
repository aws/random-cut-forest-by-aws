...
public abstract class AbstractScalarScoreVisitor implements Visitor<Double> {
	 ...
	 *            Is the maximum mass of the leaf which can be ignored
	 */
	 ...
	 *
	 * @param leafNode
	 *            The leaf node that was reached by traversing the tree
	 * @param depthOfNode
	 ...
	 * @param mass
	 *            The mass of the node being visited
	 ...
	 * 
	 * @param leafMass
	 *            The mass of the leaf node visited
	 * @param treeMass
	 *            The mass of the tree being visited
