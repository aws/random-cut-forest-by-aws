...
public class DynamicScoringRandomCutForest extends RandomCutForest {
	 ...
	 *
	 * @param point
	 *            input point being scored
	 * @param ignoreLeafMassThreshold
	 *            said threshold
	 * @param seen
	 *            the function that applies if input is equal to a previously seen
	 *            sample in a leaf
	 * @param unseen
	 *            if the input does not have a match in the leaves
	 * @param damp
	 *            damping function based on the duplicity of the previously seen
	 *            samples
	 ...
	 *            point to be scored
	 * @param seen
	 *            the score function for seen point
	 * @param unseen
	 *            score function for unseen points
	 * @param damp
	 *            dampening the score for duplicates
	 * @param vecSep
	 *            the function of (BoundingBox) -> array of probabilities
	 ...
	 *            input point
	 * @param precision
	 *            controls early convergence
	 * @param highIsCritical
	 *            this is true for the default scoring function. If the user wishes
	 *            to use a different scoring function where anomaly scores are low
	 *            values (for example, height in tree) then this should be set to
	 *            false.
	 * @param ignoreLeafMassThreshold
	 *            said threshold
	 * @param seen
	 *            scoring function when the input matches some tuple in the leaves
	 * @param unseen
	 *            scoring function when the input is not found
	 * @param damp
	 *            dampening function for duplicates which are same as input (applies
	 *            with seen)
	 ...
	 *            said threshold
	 * @param seen
	 *            score function for seen points
	 * @param unseen
	 *            score function for unseen points
	 * @param newDamp
	 *            dampening function for duplicates in the seen function
	 ...
	 *            input
	 * @param precision
	 *            parameter to stop early stopping
	 * @param highIsCritical
	 *            are high values anomalous (otherwise low values are anomalous)
	 * @param ignoreLeafEquals
	 *            should we ignore leaves with mass equal/below threshold
	 * @param ignoreLeafMassThreshold
	 *            said threshold
	 * @param seen
	 *            function for scoring points that have been seen before
	 * @param unseen
	 *            function for scoring points not seen in tree
	 * @param newDamp
	 *            dampening function based on duplicates
