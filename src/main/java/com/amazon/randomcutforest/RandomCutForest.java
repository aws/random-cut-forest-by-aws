...
public class RandomCutForest {
	 ...
	 *
	 * @param dimensions
	 *            The number of dimension in the input data.
	 * @param randomSeed
	 *            The random seed to use to create the forest random number
	 *            generator
	 ...
	 *
	 * @param point
	 *            The point used to update the forest.
	 */
	 ...
	 *
	 * @param point
	 *            The point that defines the traversal path.
	 * @param visitorFactory
	 *            A factory method which is invoked for each tree to construct a
	 *            vistor.
	 * @param accumulator
	 *            A function that combines the results from individual trees into an
	 *            aggregate result.
	 * @param finisher
	 *            A function called on the aggregate result in order to produce the
	 *            final result.
	 * @param <R>
	 *            The visitor result type. This is the type that will be returned
	 *            after traversing each individual tree.
	 * @param <S>
	 *            The final type, after any final normalization at the forest level.
	 ...
	 *            vistor.
	 * @param collector
	 *            A collector used to aggregate individual tree results into a final
	 *            result.
	 * @param <R>
	 *            The visitor result type. This is the type that will be returned
	 *            after traversing each individual tree.
	 ...
	 *            vistor.
	 * @param accumulator
	 *            An accumulator that combines the results from individual trees
	 *            into an aggregate result and checks to see if the result can be
	 ...
	 *
	 * @param point
	 *            The point where the density estimate is made.
	 ...
	 *
	 * @param point
	 *            A point with missing values.
	 * @param numberOfMissingValues
	 *            The number of missing values in the point.
	 * @param missingIndexes
	 *            An array containing the indexes of the missing values in the
	 *            point. The length of the array should be greater than or equal to
	 ...
	 * @param horizon
	 *            The number of blocks to forecast.
	 * @param blockSize
	 *            The number of entries in a block. This should be the same as the
	 *            size of a single input to the shingle.
	 * @param cyclic
	 *            If true then the shingling is cyclic, otherwise it's a sliding
	 *            shingle.
	 * @param shingleIndex
	 *            If cyclic is true, then this should be the current index in the
	 *            shingle. That is, the index where the next point added to the
	 *            shingle would be written. If cyclic is false then this value is
	 *            not used.
	 ...
	 *
	 * @param builder
	 *            The shingle builder used to process points before adding them to
	 *            the forest.
	 * @param horizon
	 *            The number of blocks to forecast.
	 * @return a forecasted time series.
	 ...
	 *
	 * @param point
	 *            A point whose neighbors we want to find.
	 * @param distanceThreshold
	 *            The maximum Euclidean distance for a point to be considered a
	 *            neighbor.
