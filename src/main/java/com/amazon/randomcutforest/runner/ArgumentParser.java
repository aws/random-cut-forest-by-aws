...
public class ArgumentParser {
	 ...
	 * 
	 * @param runnerClass
	 *            The name of the runner class where this argument parser is being
	 *            invoked.
	 * @param runnerDescription
	 *            A description of the runner class where this argument parser is
	 *            being invoked.
	 */
	 ...
	 * 
	 * @param argument
	 *            An Argument instance for a command-line argument that should be
	 *            parsed.
	 */
	 ...
	 *
	 * @param longFlag
	 *            The long flag corresponding to the argument being removed
	 */
	 ...
	 * @param formatObjects
	 *            An array of format objects that will be interpolated into the
	 *            error message using {@link String#format}.
	 */
