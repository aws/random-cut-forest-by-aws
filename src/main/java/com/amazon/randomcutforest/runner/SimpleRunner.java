...
public class SimpleRunner {
	 ...
	 * 
	 * @param runnerClass
	 *            The name of the runner class. This will be displayed in the help
	 *            text.
	 * @param runnerDescription
	 *            A description of the runner class. This will be displayed in the
	 *            help text.
	 * @param algorithmInitializer
	 *            A factory method to create a new LineTransformer instance from a
	 *            RandomCutForest.
	 */
	 ...
	 *            A argument parser that will be used by this runner to parse
	 ...
	 * 
	 * @param in
	 *            An input stream where input values will be read.
	 * @param out
	 *            An output stream where the result values will be written.
	 * @throws IOException
	 *             if IO errors are encountered during reading or writing.
	 */
	 ...
	 * 
	 * @param values
	 *            The array of values that are used to create the header. These
	 *            values will be joined together using the user-specified delimiter.
	 * @param out
	 *            The output stream where the header will be written.
	 */
	 ...
	 * 
	 * @param values
	 *            An array of string values taken from the input stream. These
	 *            values will be parsed into an array of doubles before being
	 *            transformed and written to the output stream.
	 * @param out
	 *            The output stream where the transformed line will be written.
	 */
	 ...
	 * 
	 * @param stringValues
	 *            An array of string-encoded double values.
	 */
	 ...
	 * 
	 * @param out
	 *            The output stream where additional output text may be written.
	 */
