...
public class CommonUtils {
	 ...
	 *            a condition to test
	 * @param message
	 *            the error message that will be used if the condition is not met
	 */
	 ...
	 *
	 * @param boundingBox
	 *            is the bounding box used in RandomCutTree
	 * @param queryPoint
	 *            is the multidimensional point
	 ...
	 *
	 * @param depth
	 *            The depth of the leaf node where this method is invoked
	 * @param mass
	 *            The number of times the point has been seen before
	 ...
	 * 
	 * @param scalarValue
	 *            The value being scaled
	 * @param mass
	 *            The mass of the tree where this method is invoked
